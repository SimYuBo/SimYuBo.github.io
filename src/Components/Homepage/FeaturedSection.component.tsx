...
import { FeaturedDescText, FeaturedTitleText, LfDescBoxSx, LfImageBoxSx, LfOverlayBoxSx, LfRootBoxSx, LfTitleBoxSx, RfDescBoxSx, RfImageBoxSx, RfOverlayBoxSx, RfRootBoxSx, RfTitleBoxSx } from "../../Styles/Components/FeaturedSectionStyles";
